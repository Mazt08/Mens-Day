  ...
  <body>
    ...
    <div class="category-bar">
      ...
      <li class="nav-item">
        <a
        class="nav-link"
        href="../subAccessories/Accessories Sub-Categories.html"
        >
        Accessories
        </a>
      </li>
    ...
    <div class="container popular-tops my-5">
      ...
      <div class="row text-center mt-4">
        <div class="col">
          <a href="../subOutwear/Jackets Products/Jackets page.html">
        ...
        <div class="col">
          <a href="../subOutwear/Blazer Products/Blazer page.html">
            <img src="Outerwear2.png" class="img-fluid" alt="Blazers" />
          </a>
          <div>
            <a href="../subOutwear/Blazer Products/Blazer page.html">Blazers</a>
          </div>
        </div>
        <div class="col">
          <a href="../subOutwear/Coats Products/Coats page.html">
            <img src="Outerwear3.png" class="img-fluid" alt="Coats" />
          </a>
          <div>
            <a href="../subOutwear/Coats Products/Coats page.html">Coats</a>
          </div>
        </div>
        <div class="col">
          <a href="../subOutwear/Vest Products/Vest page.html">
            <img src="Outerwear4.png" class="img-fluid" alt="Vests" />
          </a>
          <div>
            <a href="../subOutwear/Vest Products/Vest page.html">Vests</a>
          </div>
        </div>
        <div class="col">
          <a href="../subOutwear/Raincoat Products/Raincoat page.html">
