      ...
      <div class="products">
        ...
        <div class="row">
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="UrbanFlex Chinos"
                  data-color="Rosy Brown"
                  data-image="chino1.jpg"
                  data-price="158">
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="ClassicAire Chinos"
                  data-color="Vanilla"
                  data-image="chino2.jpg"
                  data-price="140">
                <div class="image-container">
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="Voyager Slim Chinos"
                  data-color="Mocha"
                  data-image="chino3.jpg"
                  data-price="141">
                <div class="image-container">
                  <img
                    src="chino3.jpg"
                    alt="Voyager Slim Chinos"
                    class="img-fluid"
                  />
                </div>
                <div class="product-details">
        ...
        <div class="row mt-4">
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="EliteStride Chinos"
                  data-color="Dull Brown"
                  data-image="chino4.jpg"
                  data-price="175">
                <div class="image-container">
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="PrimeCrest Chinos"
                  data-color="Dawn"
                  data-image="chino5.jpg"
                  data-price="133">
                <div class="image-container">
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="Terraneo Chinos"
                  data-color="Dark Grey"
                  data-image="chino6.jpg"
                  data-price="136">
                <div class="image-container">
