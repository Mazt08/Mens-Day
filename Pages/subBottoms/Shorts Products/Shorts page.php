      ...
      <div class="products">
        ...
        <div class="row">
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="BreezeCraft Shorts"
                  data-color="Dark"
                  data-image="shorts1.jpg"
                  data-price="76">
                <div class="image-container">
                  <img
                    src="shorts1.jpg"
                    alt="BreezeCraft Shorts"
                    class="img-fluid"
                  />
                </div>
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="SummitAir Shorts"
                  data-color="Night"
                  data-image="shorts2.jpg"
                  data-price="60">
                <div class="image-container">
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="CoastalDrift Shorts"
                  data-color="Storm Grey"
                  data-image="shorts3.jpg"
                  data-price="83">
                <div class="image-container">
                  <img
                    src="shorts3.jpg"
                    alt="CoastalDrift Shorts"
                    class="img-fluid"
                  />
                </div>
                <div class="product-details">
        ...
        <div class="row mt-4">
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="HorizonLine Shorts"
                  data-color="Pastel Grey"
                  data-image="shorts4.jpg"
                  data-price="77">
                <div class="image-container">
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="Solaris Shorts"
                  data-color="Tan"
                  data-image="shorts5.jpg"
                  data-price="64">
                <div class="image-container">
          ...
          <div class="col-md-4">
            <a href="">
              <div class="product-box"
                  data-name="PollaVoid Shorts"
                  data-color="Camouflage Green"
                  data-image="shorts6.jpg"
                  data-price="66">
                <div class="image-container">
